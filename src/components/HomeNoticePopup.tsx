        ...
        <div className="bg-[#0F1A2B] px-5 py-4 text-white">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="rounded-full border border-white/20 px-3 py-1 text-[12px] font-bold text-white hover:border-[#C9A857] hover:text-[#C9A857]"
            >
              닫기
            </button>
          </div>
        ...
        <div className="px-5 py-5 text-slate-700">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <button
              ...
              className="rounded-xl bg-[#0F1A2B] px-4 py-2 text-[14px] font-black text-white hover:bg-[#C9A857]"
            >
              오늘 하루 보지 않기
            </button>
            <button
              type="button"
              onClick={() => closePopup(false)}
              className="rounded-xl border border-slate-300 bg-white px-4 py-2 text-[14px] font-black text-slate-700 hover:border-[#C9A857] hover:text-[#0F1A2B]"
            >
              확인
            </button>
          </div>
